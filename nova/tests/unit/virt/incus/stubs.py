...
class MockConf(mock.Mock):
    ...
    def __init__(self, incus_args=(), incus_kwargs={}, *args, **kwargs):
        default = {
        ...
        incus_default = {
            'root_dir': '/fake/incus/root',
            'timeout': 20,
            'retry_interval': 2,
        }
        incus_default.update(incus_kwargs)
        self.incus = mock.Mock(incus_args, **incus_default)
