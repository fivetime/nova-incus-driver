...
class IncusTestLiveMigrate(test.NoDBTestCase):

    def setUp(self):
        super(IncusTestLiveMigrate, self).setUp()
    ...
    @mock.patch.object(driver.IncusDriver, '_migrate')
    ...
    def test_live_migration_failed(self, mock_migrate):
        ...
        mock_migrate.side_effect = \
            incus_exceptions.APIError(500, 'Fake')
        self.assertRaises(
            incus_exceptions.APIError,
