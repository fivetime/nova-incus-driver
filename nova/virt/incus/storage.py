...
def attach_ephemeral(client, block_device_info, incus_config, instance):
    ...
    if ephemeral_storage:
        ...
        for ephemeral in ephemeral_storage:
            ...
            if storage_driver == 'zfs':
                ...
                # We re-use the same btrfs subvolumes that Incus uses,
                ...
                lvm_pool = incus_config['config']['storage.lvm_vg_name']
                ...
                reason = _("Unsupport Incus storage detected. Supported"
...
def detach_ephemeral(client, block_device_info, incus_config, instance):
